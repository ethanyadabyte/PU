...
function Search(props: { query?: string; Type?: any }) {
  const { isLoading, error, data } = useQuery(
    ...
    () =>
      fetch(
        `
        https://api.themoviedb.org/3/${props.Type}/${props.query}/tv_credits?api_key=bc7d2aaf31b58d13aba81c2dfa7e88ab&language=en-US`
      ).then((res) => res.json()),
    {}
  );
