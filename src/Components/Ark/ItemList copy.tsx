...
export const ItemList = (props: MovieListProps) => {
  return (
    <ul className="grid place-items-center xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 gap-none w-auto pl-4 bg-gray-700 ">
      {props.results.map((movie) => (
        /*<Link to={`/Item/${movie.id}/${movie.media_type}`}>*/
        <li className="my-4 flex hide text-transparent hover:text-gray-200 w-52 h-70 rounded-lg  ">
          <img
